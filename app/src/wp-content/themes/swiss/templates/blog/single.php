...
<div class="s-context">
    ...
    <section class="b-blog">
        ...
        <div class="b-blog__container b-blog__container--wider">
            ...
            <div data-animate="animated zoomIn" class="c-card">
                ...
                <div class="c-card__readmore"><a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="c-cta-link"><?php _e('Read more', 'swiss'); ?></a></div>
