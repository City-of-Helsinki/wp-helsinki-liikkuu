...
An image + text block for Everblox. [See this block in action!](http://swiss.evermade.fi/)
...
* `em everblox add image-text my-new-block` will clone the `image-text` block to a new block called `my-new-block`
