...
* `em everblox add hero my-new-hero` will clone the `example` block to a new block called `my-new-hero`
...
[See an issue, have an awesome suggestion, or just have a bug fix? Please report it.](https://bitbucket.org/evermade/hero-block/issues/new)
